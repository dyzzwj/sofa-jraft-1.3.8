...
public class CounterServer {
     ...
     *      1、Raft通讯和业务通讯，使用同一个RpcServer，如当前CountServer。
     *      2、Raft通讯使用JRaft提供的RpcServer，业务Server使用SpringBoot开发HttpServer，如Nacos。
     ...
     * - Node：实现类是NodeImpl，主要负责提交议案(apply)和线性一致性读(readIndex)。
     */
